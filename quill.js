...
var _authorship = __webpack_require__(74);
...
*/
var Quill = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"quill\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var Parchment = Quill.import('parchment');
var Delta = __webpack_require__(2);

var AuthorClass = new Parchment.Attributor.Class('author', 'ql-author', {
  ...
  function Authorship(quill, options) {
    ...
    this.quill.on(Quill.events.EDITOR_CHANGE, function (eventName, delta, oldDelta, source) {
      ...
      if (eventName == Quill.events.TEXT_CHANGE && source == 'user') {
        ...
        var authorFormat = { author: _this.options.authorId }; // bug is here how to apply Attributor class to delta?
        ...
        _this.quill.updateContents(authorDelta, Quill.sources.SILENT);
      }
    });
    ...
    var customButton = document.querySelector('button.ql-authorship-toggle');

    var authorshipObj = this;
